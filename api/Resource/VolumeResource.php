...
class VolumeResource extends Resource
{
    ...
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\VolumesGetResponse200|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function volumeList($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\VolumesGetResponse200', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\Volume|\Dockent\OpenAPI\Model\ErrorResponse
     */
    public function volumeCreate(\Dockent\OpenAPI\Model\VolumesCreatePostBody $volumeConfig, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\Volume', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
    ...
    * @param string $fetch      Fetch mode (object or response)
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\VolumesPrunePostResponse200|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function volumePrune($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\VolumesPrunePostResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
