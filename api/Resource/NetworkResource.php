...
class NetworkResource extends Resource
{
    ...
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\Network[]|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function networkList($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\Network[]', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\NetworksCreatePostResponse201|\Dockent\OpenAPI\Model\ErrorResponse
     */
    public function networkCreate(\Dockent\OpenAPI\Model\NetworksCreatePostBody $networkConfig, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\NetworksCreatePostResponse201', 'json');
            }
            if ('403' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
    ...
    * @param string $fetch      Fetch mode (object or response)
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\NetworksPrunePostResponse200|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function networkPrune($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\NetworksPrunePostResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
