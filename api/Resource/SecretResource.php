...
class SecretResource extends Resource
{
    ...
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\Secret[]|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function secretList($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\Secret[]', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\SecretsCreatePostResponse201|\Dockent\OpenAPI\Model\ErrorResponse
     */
    public function secretCreate(\Dockent\OpenAPI\Model\SecretsCreatePostBody $body, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\SecretsCreatePostResponse201', 'json');
            }
