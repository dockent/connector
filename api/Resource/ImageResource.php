...
class ImageResource extends Resource
{
    ...
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\ImageSummary[]|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function imageList($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ImageSummary[]', 'json');
            }
    ...
    */
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\BuildPrunePostResponse200|\Dockent\OpenAPI\Model\ErrorResponse
     */
    public function buildPrune($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\BuildPrunePostResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\Image|\Dockent\OpenAPI\Model\ErrorResponse
     */
    public function imageInspect($name, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\Image', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\ImagesNameHistoryGetResponse200Item[]|\Dockent\OpenAPI\Model\ErrorResponse
     */
    public function imageHistory($name, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ImagesNameHistoryGetResponse200Item[]', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
    ...
    * @param string $fetch      Fetch mode (object or response)
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\ImageDeleteResponseItem[]|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function imageDelete($name, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ImageDeleteResponseItem[]', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
    ...
    * @param string $fetch      Fetch mode (object or response)
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\ImagesSearchGetResponse200Item[]|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function imageSearch($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ImagesSearchGetResponse200Item[]', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
    ...
    * @param string $fetch      Fetch mode (object or response)
    *
    * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\ImagesPrunePostResponse200|\Dockent\OpenAPI\Model\ErrorResponse
    */
    public function imagePrune($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ImagesPrunePostResponse200', 'json');
            }
            if ('500' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\Dockent\OpenAPI\Model\IdResponse|\Dockent\OpenAPI\Model\ErrorResponse
     */
    public function imageCommit(\Dockent\OpenAPI\Model\ContainerConfig $containerConfig, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('201' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\IdResponse', 'json');
            }
            if ('404' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'Dockent\\OpenAPI\\Model\\ErrorResponse', 'json');
            }
