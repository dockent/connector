...
class VolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\Volume') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\Volume) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\Volume();
        ...
        if (property_exists($data, 'UsageData')) {
            $object->setUsageData($this->denormalizer->denormalize($data->{'UsageData'}, 'Dockent\\OpenAPI\\Model\\VolumeUsageData', 'json', $context));
        }
        return $object;
    }
