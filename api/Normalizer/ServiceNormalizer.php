...
class ServiceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\Service') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\Service) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\Service();
        ...
        if (property_exists($data, 'Spec')) {
            $object->setSpec($this->denormalizer->denormalize($data->{'Spec'}, 'Dockent\\OpenAPI\\Model\\ServiceSpec', 'json', $context));
        }
        if (property_exists($data, 'Endpoint')) {
            $object->setEndpoint($this->denormalizer->denormalize($data->{'Endpoint'}, 'Dockent\\OpenAPI\\Model\\ServiceEndpoint', 'json', $context));
        }
        if (property_exists($data, 'UpdateStatus')) {
            $object->setUpdateStatus($this->denormalizer->denormalize($data->{'UpdateStatus'}, 'Dockent\\OpenAPI\\Model\\ServiceUpdateStatus', 'json', $context));
        }
        return $object;
    }
