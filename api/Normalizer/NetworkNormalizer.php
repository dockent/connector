...
class NetworkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\Network') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\Network) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\Network();
        ...
        if (property_exists($data, 'IPAM')) {
            $object->setIPAM($this->denormalizer->denormalize($data->{'IPAM'}, 'Dockent\\OpenAPI\\Model\\IPAM', 'json', $context));
        }
        ...
        if (property_exists($data, 'Containers')) {
            ...
            foreach ($data->{'Containers'} as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Dockent\\OpenAPI\\Model\\NetworkContainer', 'json', $context);
            }
