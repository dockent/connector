...
class ContainerSummaryItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\ContainerSummaryItem') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\ContainerSummaryItem) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\ContainerSummaryItem();
        ...
        if (property_exists($data, 'Ports')) {
            ...
            foreach ($data->{'Ports'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Dockent\\OpenAPI\\Model\\Port', 'json', $context);
            }
        ...
        if (property_exists($data, 'HostConfig')) {
            $object->setHostConfig($this->denormalizer->denormalize($data->{'HostConfig'}, 'Dockent\\OpenAPI\\Model\\ContainerSummaryItemHostConfig', 'json', $context));
        }
        if (property_exists($data, 'NetworkSettings')) {
            $object->setNetworkSettings($this->denormalizer->denormalize($data->{'NetworkSettings'}, 'Dockent\\OpenAPI\\Model\\ContainerSummaryItemNetworkSettings', 'json', $context));
        }
        if (property_exists($data, 'Mounts')) {
            $values_3 = array();
            foreach ($data->{'Mounts'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Dockent\\OpenAPI\\Model\\Mount', 'json', $context);
            }
