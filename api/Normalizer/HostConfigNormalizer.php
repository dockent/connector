...
class HostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\HostConfig') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\HostConfig) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\HostConfig();
        ...
        if (property_exists($data, 'BlkioWeightDevice')) {
            ...
            foreach ($data->{'BlkioWeightDevice'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Dockent\\OpenAPI\\Model\\ResourcesBlkioWeightDeviceItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'BlkioDeviceReadBps')) {
            ...
            foreach ($data->{'BlkioDeviceReadBps'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Dockent\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (property_exists($data, 'BlkioDeviceWriteBps')) {
            ...
            foreach ($data->{'BlkioDeviceWriteBps'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Dockent\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (property_exists($data, 'BlkioDeviceReadIOps')) {
            ...
            foreach ($data->{'BlkioDeviceReadIOps'} as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Dockent\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (property_exists($data, 'BlkioDeviceWriteIOps')) {
            ...
            foreach ($data->{'BlkioDeviceWriteIOps'} as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Dockent\\OpenAPI\\Model\\ThrottleDevice', 'json', $context);
            }
        ...
        if (property_exists($data, 'Devices')) {
            ...
            foreach ($data->{'Devices'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Dockent\\OpenAPI\\Model\\DeviceMapping', 'json', $context);
            }
        ...
        if (property_exists($data, 'Ulimits')) {
            ...
            foreach ($data->{'Ulimits'} as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Dockent\\OpenAPI\\Model\\ResourcesUlimitsItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'LogConfig')) {
            $object->setLogConfig($this->denormalizer->denormalize($data->{'LogConfig'}, 'Dockent\\OpenAPI\\Model\\HostConfigLogConfig', 'json', $context));
        }
        ...
        if (property_exists($data, 'PortBindings')) {
            ...
            foreach ($data->{'PortBindings'} as $key => $value_9) {
                $values_9[$key] = $this->denormalizer->denormalize($value_9, 'Dockent\\OpenAPI\\Model\\HostConfigPortBindingsItem', 'json', $context);
            }
            $object->setPortBindings($values_9);
        }
        if (property_exists($data, 'RestartPolicy')) {
            $object->setRestartPolicy($this->denormalizer->denormalize($data->{'RestartPolicy'}, 'Dockent\\OpenAPI\\Model\\RestartPolicy', 'json', $context));
        }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_11) {
                $values_11[] = $this->denormalizer->denormalize($value_11, 'Dockent\\OpenAPI\\Model\\Mount', 'json', $context);
            }
