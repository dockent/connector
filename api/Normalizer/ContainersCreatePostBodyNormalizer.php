...
class ContainersCreatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\ContainersCreatePostBody') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\ContainersCreatePostBody) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\ContainersCreatePostBody();
        ...
        if (property_exists($data, 'Volumes')) {
            $object->setVolumes($this->denormalizer->denormalize($data->{'Volumes'}, 'Dockent\\OpenAPI\\Model\\ContainerConfigVolumes', 'json', $context));
        }
        ...
        if (property_exists($data, 'NetworkingConfig')) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data->{'NetworkingConfig'}, 'Dockent\\OpenAPI\\Model\\ContainersCreatePostBodyNetworkingConfig', 'json', $context));
        }
        return $object;
    }
