...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\TaskSpecContainerSpec') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\TaskSpecContainerSpec) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\TaskSpecContainerSpec();
        ...
        if (property_exists($data, 'Privileges')) {
            $object->setPrivileges($this->denormalizer->denormalize($data->{'Privileges'}, 'Dockent\\OpenAPI\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
        }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Dockent\\OpenAPI\\Model\\Mount', 'json', $context);
            }
        ...
        if (property_exists($data, 'HealthCheck')) {
            $object->setHealthCheck($this->denormalizer->denormalize($data->{'HealthCheck'}, 'Dockent\\OpenAPI\\Model\\HealthConfig', 'json', $context));
        }
        ...
        if (property_exists($data, 'DNSConfig')) {
            $object->setDNSConfig($this->denormalizer->denormalize($data->{'DNSConfig'}, 'Dockent\\OpenAPI\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
        }
        if (property_exists($data, 'Secrets')) {
            $values_7 = array();
            foreach ($data->{'Secrets'} as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Dockent\\OpenAPI\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
        ...
        if (property_exists($data, 'Configs')) {
            ...
            foreach ($data->{'Configs'} as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Dockent\\OpenAPI\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
            }
