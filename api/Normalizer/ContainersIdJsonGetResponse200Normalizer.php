...
class ContainersIdJsonGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\ContainersIdJsonGetResponse200') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\ContainersIdJsonGetResponse200) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\ContainersIdJsonGetResponse200();
        ...
        if (property_exists($data, 'State')) {
            $object->setState($this->denormalizer->denormalize($data->{'State'}, 'Dockent\\OpenAPI\\Model\\ContainersIdJsonGetResponse200State', 'json', $context));
        }
        ...
        if (property_exists($data, 'HostConfig')) {
            $object->setHostConfig($this->denormalizer->denormalize($data->{'HostConfig'}, 'Dockent\\OpenAPI\\Model\\HostConfig', 'json', $context));
        }
        if (property_exists($data, 'GraphDriver')) {
            $object->setGraphDriver($this->denormalizer->denormalize($data->{'GraphDriver'}, 'Dockent\\OpenAPI\\Model\\GraphDriverData', 'json', $context));
        }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Dockent\\OpenAPI\\Model\\MountPoint', 'json', $context);
            }
            $object->setMounts($values_1);
        }
        if (property_exists($data, 'Config')) {
            $object->setConfig($this->denormalizer->denormalize($data->{'Config'}, 'Dockent\\OpenAPI\\Model\\ContainerConfig', 'json', $context));
        }
        if (property_exists($data, 'NetworkSettings')) {
            $object->setNetworkSettings($this->denormalizer->denormalize($data->{'NetworkSettings'}, 'Dockent\\OpenAPI\\Model\\NetworkSettings', 'json', $context));
        }
        return $object;
    }
