...
class PluginConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\PluginConfig') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\PluginConfig) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\PluginConfig();
        ...
        if (property_exists($data, 'Interface')) {
            $object->setInterface($this->denormalizer->denormalize($data->{'Interface'}, 'Dockent\\OpenAPI\\Model\\PluginConfigInterface', 'json', $context));
        }
        ...
        if (property_exists($data, 'User')) {
            $object->setUser($this->denormalizer->denormalize($data->{'User'}, 'Dockent\\OpenAPI\\Model\\PluginConfigUser', 'json', $context));
        }
        if (property_exists($data, 'Network')) {
            $object->setNetwork($this->denormalizer->denormalize($data->{'Network'}, 'Dockent\\OpenAPI\\Model\\PluginConfigNetwork', 'json', $context));
        }
        if (property_exists($data, 'Linux')) {
            $object->setLinux($this->denormalizer->denormalize($data->{'Linux'}, 'Dockent\\OpenAPI\\Model\\PluginConfigLinux', 'json', $context));
        }
        ...
        if (property_exists($data, 'Mounts')) {
            ...
            foreach ($data->{'Mounts'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Dockent\\OpenAPI\\Model\\PluginMount', 'json', $context);
            }
        ...
        if (property_exists($data, 'Env')) {
            ...
            foreach ($data->{'Env'} as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Dockent\\OpenAPI\\Model\\PluginEnv', 'json', $context);
            }
            $object->setEnv($values_2);
        }
        if (property_exists($data, 'Args')) {
            $object->setArgs($this->denormalizer->denormalize($data->{'Args'}, 'Dockent\\OpenAPI\\Model\\PluginConfigArgs', 'json', $context));
        }
        if (property_exists($data, 'rootfs')) {
            $object->setRootfs($this->denormalizer->denormalize($data->{'rootfs'}, 'Dockent\\OpenAPI\\Model\\PluginConfigRootfs', 'json', $context));
        }
        return $object;
    }
