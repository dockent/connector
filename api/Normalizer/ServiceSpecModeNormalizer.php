...
class ServiceSpecModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\ServiceSpecMode') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\ServiceSpecMode) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\ServiceSpecMode();
        if (property_exists($data, 'Replicated')) {
            $object->setReplicated($this->denormalizer->denormalize($data->{'Replicated'}, 'Dockent\\OpenAPI\\Model\\ServiceSpecModeReplicated', 'json', $context));
        }
