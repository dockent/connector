...
class MountVolumeOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\MountVolumeOptions') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\MountVolumeOptions) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\MountVolumeOptions();
        ...
        if (property_exists($data, 'DriverConfig')) {
            $object->setDriverConfig($this->denormalizer->denormalize($data->{'DriverConfig'}, 'Dockent\\OpenAPI\\Model\\MountVolumeOptionsDriverConfig', 'json', $context));
        }
        return $object;
    }
