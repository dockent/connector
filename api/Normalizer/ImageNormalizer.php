...
class ImageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\Image') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\Image) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\Image();
        ...
        if (property_exists($data, 'ContainerConfig')) {
            $object->setContainerConfig($this->denormalizer->denormalize($data->{'ContainerConfig'}, 'Dockent\\OpenAPI\\Model\\ContainerConfig', 'json', $context));
        }
        ...
        if (property_exists($data, 'RootFS')) {
            $object->setRootFS($this->denormalizer->denormalize($data->{'RootFS'}, 'Dockent\\OpenAPI\\Model\\ImageRootFS', 'json', $context));
        }
        if (property_exists($data, 'Metadata')) {
            $object->setMetadata($this->denormalizer->denormalize($data->{'Metadata'}, 'Dockent\\OpenAPI\\Model\\ImageMetadata', 'json', $context));
        }
        return $object;
    }
