...
class BuildInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'Dockent\\OpenAPI\\Model\\BuildInfo') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Dockent\OpenAPI\Model\BuildInfo) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Dockent\OpenAPI\Model\BuildInfo();
        ...
        if (property_exists($data, 'errorDetail')) {
            $object->setErrorDetail($this->denormalizer->denormalize($data->{'errorDetail'}, 'Dockent\\OpenAPI\\Model\\ErrorDetail', 'json', $context));
        }
